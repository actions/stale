...
If you reached the limit, you will see a warning message in the logs, telling you that you should decrease the number of operations.
If you choose not to decrease the limit, you might end up with unprocessed issues or pull requests after a stale action run.
